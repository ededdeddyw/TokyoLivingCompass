...
# 都営4線 + 都電荒川線 + 日暮里舎人 / 東京メトロ9線 /
# JR山手・中央快速・中央総武・埼京 / 23区を通る私鉄各線。
# 埼京線は当初の対象に入れていなかったが、板橋・十条・赤羽が抜け落ちるため後から加えた。
TARGET_LINES = [
    "99301", "99302", "99303", "99304", "99305", "99342",
    "28001", "28002", "28003", "28004", "28005", "28006", "28008", "28009", "28010",
    "11302", "11312", "11313", "11321",
    # JR の在来線は当初 4 線だけを対象にしていたが、それだと亀有（常磐線）・
    # 葛西臨海公園（京葉線）・西大井（横須賀線）・尾久（宇都宮線）のように、
    # ほかの路線が通らない駅が23区内にありながら抜け漏れる。
    # 23区内に駅を持つ在来線はすべて対象にする。
    "11301", "11308", "11311", "11314", "11319", "11320",
    "11323", "11326", "11332", "11333", "11343",
    "21001", "21002", "21005", "21006",
    "22001", "22003", "22004", "22007",
    "23001", "23002", "23003", "23006",
    "24001", "24006", "24007",
    "25001",
...
SLUG_OVERRIDE = {"西馬込": "nishimagome", "中目黒": "nakameguro",
                 # ODPT のローマ字が Kasairinkaikoen と続けて書かれており、
                 # 語の切れ目が機械では取れない。
