...
<div class="wrap">
  ...
  <section class="caveat">
    ...
    <p>
      ...
      2026-09-13 に、店名と坂を実データから取り直した。
      店名・座標・徒歩分数は OpenStreetMap（ODbL）から、標高は国土地理院の標高APIから
      取っている。それ以前は書き手の記憶で書いており、スーパー64件のうち50件が
      実在しなかった。坂は17駅中11駅で判定が違い、うち5駅は上りと下りが逆だった。
    </p>
  </section>
